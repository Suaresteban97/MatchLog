...
class UpdateGameSessionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'max_participants' => 'sometimes|required|integer|min:2|max:100',
            'status' => 'sometimes|in:scheduled,active,finished,cancelled',
    ...
    public function messages(): array
    {
        return [
            ...
            'status.in' => 'El estado debe ser: scheduled, active, finished o cancelled',
