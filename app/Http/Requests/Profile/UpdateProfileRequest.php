...
class UpdateProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // Visibility toggles
            'show_posts'           => 'nullable|boolean',
            'show_backlog'         => 'nullable|boolean',
            'show_collections'     => 'nullable|boolean',
            'show_groups'          => 'nullable|boolean',
            'show_social_profiles' => 'nullable|boolean',
            'show_devices'         => 'nullable|boolean',
        ];
    }
